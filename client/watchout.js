...
var filter = definitions.append('filter').attr('id', 'blur')
  .append('feGaussianBlur').attr('stdDeviation', 3);

var spaceship = definitions.append('g').attr({
  'id' : 'spaceship',
  //'stroke' : 'none',
    //'stroke-width' : 1,
    // 'fill' : 'none',
...
var pilot = spaceship.append('image').attr({
  'x' : 35,
  'height' : '85px',
  'width' : '85px',
  'xlink:href' : 'avatar.gif'
});

var ship = spaceship.append('path').attr({
  'fill' : '#333',
...
var lights = spaceship.append('g').attr('transform', 'translate(13.000000, 58.000000)')
  .append('path').attr({
    'class' : 'lights',
...
var pod = spaceship.append('path').attr({
  'class' : 'spaceship-pod',
  'stroke' : '#333',
  'stroke-width' : '2',
